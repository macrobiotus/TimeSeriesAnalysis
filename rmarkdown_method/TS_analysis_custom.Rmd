...
author: "Yohan Lefol and Paul Czechowski"
...
name_result_folder <- '/Users/paul/Documents/HM_MouseDynamics/1_analysis/tisa_input/heart'
obj_name <- 'tisa_output_heart.Rdata'

# Path to count data and sample data respectively - Not needed if using example data
my_path_data <- '/Users/paul/Documents/HM_MouseDynamics/1_analysis/tisa_input/heart/tisa_counts.txt'
my_path_sample_dta <- '/Users/paul/Documents/HM_MouseDynamics/1_analysis/tisa_input/heart/tisa_sampls.csv'
...
l2fc_thresh <- 0.5          # log(2)foldChange threshold for significance
...
# Set the species for the gprofiler analysis

my_org_gpro = 'mmusculus' 
...
log_tp_traj <- FALSE  # Defines if timee points should be log transformed for illustration purposes
...
This code chunk first checks if a times eries object has been saved, if that is the 
case, the object is loaded instead of being created again. To reset this analysis, the
saved times eries object should be deleted or moved from the repository.  
If no time series object was found, the code chunk creates the time series object 
